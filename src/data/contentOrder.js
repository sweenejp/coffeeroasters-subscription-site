const contentOrder = {
  ...
  summaryModal: {
    heading: "Order Summary",
    body: "",
    help: "Is this correct? You can proceed to checkout or go back to plan selection if something is off. Subscription discount codes can also be redeemed at the checkout. ",
  },
};
